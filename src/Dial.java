...
public class Dial extends JPanel {
  ...
  public static final BasicStroke DIAL_THICK_STROKE = new BasicStroke(DIAL_STROKE_WIDTH,
      BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL);
  ...
  public Dimension getPreferredSize() {
    return new Dimension(LABELLED_DIAL_WIDTH, LABELLED_DIAL_WIDTH);
  }
...
f.show();
  ...
  public Dial(double initialValue) {
    ...
    addMouseListener(new MouseAdapter() {
      ...
      public void mouseReleased(MouseEvent e) {
        if (e
            == lastRelease) // we just had this event because we're in the AWT Event Listener.  So we ignore it
        {
          return;
        }
  ...
  public void paintComponent(Graphics g) {
    ...
    arc.setArc(rect.getX() + DIAL_STROKE_WIDTH / 2, rect.getY() + DIAL_STROKE_WIDTH / 2,
        rect.getWidth() - DIAL_STROKE_WIDTH, rect.getHeight() - DIAL_STROKE_WIDTH, startAngle,
        interval, Arc2D.OPEN);
